...
(() => {
    ...
    const 
        ...
        uiSet = () => {
            const p = gMsgPanelPrefix.RecordWin, s = gMsgPanelSuffix.RecordWin;
            elRecordAllTxt.innerHTML = p+mRecord.Win+s+"/ "+mRecord.Sum;
            elRecordPvETxt.innerHTML = p+mRecord.PvEWin+s+"/ "+mRecord.PvESum;
            elRecordPvELvTxt.innerHTML = gMsgPanelPrefix.Level+mRecord.PvELv+gMsgPanelSuffix.Level;
...
<div class="alert">
    ...
    elBody.onload = () => {
        elRecord[0].innerHTML = gMsgPanelName.Record;
        elRecordAll.firstChild.textContent = gMsgPanelName.RecordNum;
        elRecordPvE.firstChild.textContent = gMsgPanelName.RecordPvE;
        elRecordPvELv.firstChild.textContent = gMsgPanelName.RecordPvELv;
        elRecordPvP.firstChild.textContent = gMsgPanelName.RecordPvP;
        elRecordLink.innerHTML = gMsgPanelName.RecordTable;
        elChange[0].innerHTML = gMsgPanelName.Change;
        elRename[0].innerHTML = gMsgPanelName.Rename;
        elRepass[0].innerHTML = gMsgPanelName.Repass;
        elRenameSubmit.innerHTML = gMsgPanelName.Submit;
        elRepassSubmit.innerHTML = gMsgPanelName.Submit;
        elRenameDesc.innerHTML = gMsgPanelDesc.Rename;
        elRepassDesc.innerHTML = gMsgPanelDesc.Repass;
        uiSet();
    }
