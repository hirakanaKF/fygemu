...
(() => {
    ...
    elBody.onload = () => {
        elIdLeft.innerHTML = gMsgPanelName.Id;
        elPwdLeft.innerHTML = gMsgPanelName.Pw;
        elLoginName.innerHTML = gMsgPanelName.Login;
        elLoginDesc.textContent = gMsgPanelDesc.Login;
        elSignupName.innerHTML = gMsgPanelName.Signup;
        elSignupDesc.textContent = gMsgPanelDesc.Signup;
    };
