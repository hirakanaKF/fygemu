...
const 
    ...
    gSetLang = (lang) => {
        ...
        window.gMsgActorMyst = msg.ActorMyst;
    ...
    uiActor = () => {
        const
            ...
            set = (d) => {
                const {i, K, R, V, L, Q, S, B, F, G, M, p, exp, auras, equip, fruit} = d;

                elRoot.K = K; elRoot.R = R; elRoot.L = L; elRoot.V = V;
                elRoot.Q = Q; elRoot.S = S; elRoot.B = B; elRoot.F = F; elRoot.G = G; elRoot.M = M;
                elRoot.p = p;
                ...
                elMyst.innerHTML = gMsgActorMyst[K] ?? K;
            ...
            clr = () => {
                set({K: 0, R: 1, V: 0, L: 0, Q: 0, S: 0, B: 0, F: 0, G: 0, p: 0, exp: 0, auras: [], equip: [], fruit: []}); open(!1);
        ...
        elRoot.onload = () => {
            const K = elRoot.K;
            tnName.textContent = gMsgActorName[K] ?? K;
            elDesc.innerHTML = gMsgActorDesc[K] ?? K; elMyst.innerHTML = gMsgActorMyst[K] ?? K;
    ...
    const
        bmsgJpt = {
            ...
            [$BmArt1]: (i, m) => `<i class="icon icon-location-arrow"><b>${gMsgArt1Name[i]}${gMsgData[$MsgSkillPrefix]}${m}${gMsgData[$MsgSkillSuffix]}</b></i>`,
            [$BmArt2]: (i, m) => `<i class="icon icon-location-arrow"><b>${gMsgArt2Name[i]}${gMsgData[$MsgSkillPrefix]}${m}${gMsgData[$MsgSkillSuffix]}</b></i>`,
            [$BmArt3]: (i, m) => `<i class="icon icon-location-arrow"><b>${gMsgArt3Name[i]}${gMsgData[$MsgSkillPrefix]}${m}${gMsgData[$MsgSkillSuffix]}</b></i>`,
            [$BmAura]: (i, m) => `<i class="icon icon-bookmark-empty"><b>${gMsgAuraName[i]}${gMsgData[$MsgAuraPrefix]}${m}${gMsgData[$MsgAuraSuffix]}</b></i>`,
            [$BmArt1Ex]: (i, m) => `<i class="icon icon-location-arrow"><b>${gMsgArt1Name[i]}${gMsgData[$MsgSkillPrefix]}${gMsgData[m] ?? m}${gMsgData[$MsgSkillSuffix]}</b></i>`,
            [$BmArt2Ex]: (i, m) => `<i class="icon icon-location-arrow"><b>${gMsgArt2Name[i]}${gMsgData[$MsgSkillPrefix]}${gMsgData[m] ?? m}${gMsgData[$MsgSkillSuffix]}</b></i>`,
            [$BmArt3Ex]: (i, m) => `<i class="icon icon-location-arrow"><b>${gMsgArt3Name[i]}${gMsgData[$MsgSkillPrefix]}${gMsgData[m] ?? m}${gMsgData[$MsgSkillSuffix]}</b></i>`,
        },
        bmsgNop = (i, m) => "",
